...
export const COPY = {
  en: {
    ...
    einWhy: 'Since you selected a business goal, you can provide an EIN for your business account.',
  ...
  es: {
    ...
    einWhy: 'Dado que seleccionó un objetivo comercial, puede proporcionar un EIN para su cuenta comercial.',
